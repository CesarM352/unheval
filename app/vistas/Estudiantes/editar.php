...
<body class="hold-transition sidebar-mini layout-fixed" style="padding-left: 40px">
    <div class="container-fluid">
        <form onsubmit="return verifyPassword() && matchPassword() && valida_dni()" action="actualizar.php?codigoestudiante=<?php echo $codigoestudiante ?>" method="POST">
            <br>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" name="nombre" value="<?php echo utf8_encode($estudiantes_mdl->getNombre()) ?>" pattern="[A-Za-záéíóú ]{1,100}" title="(No se permiten números en este campo)"/>
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <input type="number" class="form-control" name="dni" id="dni"value="<?php echo $estudiantes_mdl->getDni() ?>"/>
                    <input type="hidden" class="form-control" id="dnicompare" value="<?php echo $estudiantes_mdl->getDni() ?>"/>
                </div>
                <div class="col-md-4">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-2">
                    <input class="form-control" type="number" name="celular" value="<?php echo $estudiantes_mdl->getCelular() ?>"/>
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-2">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-3">
                    <input class="form-control" type="email" name="email" value="<?php echo $estudiantes_mdl->getEmail() ?>"/>
                </div>
            </div>
            <!--<div class="row form-group">
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <input class="form-control" type="password" name="pass" value="<?php echo $estudiantes_mdl->getPass() ?>"/>
                </div>
            </div>-->
            <br>
            <div class="row form-group">
