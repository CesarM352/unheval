...
?>
    <tr id="fila_<?php echo $ambiente["id"] ?>" class=" tbl_datos_filas tipo_ambiente_<?php echo $ambiente["tipo_ambiente_id"] ?>">
        <td> <?php echo $ambiente["nombre"] ?> </td>
        <td> <?php echo $ambiente["tipo_ambiente_denominacion"] ?> </td>
        <td> 
			<a href="ver_software.php?ambiente_id=<?php echo $ambiente["id"] ?>" > Ver Software</a> 
		</td>
    </tr>
<?php
    }
